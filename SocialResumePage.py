...
#name label
    label1 = Label(frame1,text="NAME", height=1, width=20,bg="#c590ff",fg='#0e005b',font="TimesNewRoman 14 bold").grid(row=1, column=0,padx=20,pady=20)
    label1 = StringVar()
    namelabel= Label(frame1,text=f"{resumeName}", height=1, width=20,fg='black',font="TimesNewRoman 12").grid(row=1, column=1)
#Gender label
    label3 = Label( frame1, text= "GENDER", height=1, width=20,bg="#c590ff",fg='#0e005b',font="TimesNewRoman 14 bold")
    label3.grid(row=2,column=0,sticky='W',padx=20,pady=20)
    genderlabel = Label(frame1,text=f"{resumeGender}", height=1, width=20,fg='black',font="TimesNewRoman 12").grid(row=2, column=1)
#Email label
    label5 = Label(frame1,text="EMAIL-ID", height=1, width=20,bg="#c590ff",fg='#0e005b',font="TimesNewRoman 14 bold").grid(row=3, column=0)
    emaillabel = Label(frame1,text=f"{resumeEmail}", height=1, width=20,fg='black',font="TimesNewRoman 12").grid(row=3, column=1)
#bio label
    label4 = Label(frame2, text="BIO", height=1, width=20, bg="#c590ff", fg='#0e005b',font="TimesNewRoman 14 bold").grid(row=7, column=0)
    biolabel = Label(frame2, text=f"{resumeBio}", height=10, width=20, fg='black', font="TimesNewRoman 12").grid(row=7,column=1)
    biolabel = StringVar()
#DP canvas
    dp = Image.open(r"images_clicked\{}.png".format(resumeImage))
    ...
    img = PhotoImage(file=r"image/linkdin.png")
    ...
    linkedinbtn.grid(row=9,column=1,sticky='W',padx=35)
    ...
    img1 = PhotoImage(file=r"image/fb.png")
    ...
    img3 = PhotoImage(file=r"image/instagram.png")
    ...
    img4 = PhotoImage(file=r"image/spot.png")
    ...
    spotifybtn.grid(row=13,column=1,sticky='W',padx=55)
    ...
    img5 = PhotoImage(file=r"image/snap.png")
    ...
    img6 = PhotoImage(file=r"image/twitter.png")
